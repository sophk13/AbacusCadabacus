...
class Sensor:
    ...
    def __init__(self, sda_pin, scl_pin,ADD,channel):
        ...
        self.I2C.writeto(self.DEV_ADDR,bytearray([CONF_PORT0,0b11111110]))
        self.I2C.writeto(self.DEV_ADDR,bytearray([CONF_PORT1,0b11111111]))     

        # set polarity of inputs; D1-D7 flip polarity, D0 retain original polarity
        self.I2C.writeto(self.DEV_ADDR,bytearray([POLARITY_PORT0,0b11111110]))
        self.I2C.writeto(self.DEV_ADDR,bytearray([POLARITY_PORT1,0b00000011]))

        # Set D0 off (LEDs off)
        self.I2C.writeto(self.DEV_ADDR,bytearray([OUTPUT_PORT0,0b00000000]))
        
    def read(self):

        # Turn on the LEDs in the line sensor
        self.I2C.writeto(self.DEV_ADDR,bytearray([OUTPUT_PORT0,0b00000001]))
